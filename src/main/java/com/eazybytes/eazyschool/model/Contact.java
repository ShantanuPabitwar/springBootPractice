...
@NamedQueries({
        @NamedQuery(name="Contact.findOpenStatus", query = "SELECT c WHERE Contact c = :status"),
        @NamedQuery(name= "Contact.closeStatus", query = "UPDATE Contact c SET c.status = ?1 WHERE c.contactId = ?2")
})
@NamedNativeQueries({
